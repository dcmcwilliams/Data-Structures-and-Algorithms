...
* Author: Daphne
*/
// Daphne McWilliams COSC 600: Program to insert 5000 random elements 1 by 1 into an empty binary heap.
// Counts number of swaps and prints first 50 elements of heap.
...
void binHeap::insertVal(int k) {
    ...
    // Fix the heap property if violated (if parent is greater than child, swap places)
...
int main() {
	...
	cout << "The first 50 elements of the binary heap of 5000 random integers: " << endl;
	for (int i = 0; i < 50; i++)
